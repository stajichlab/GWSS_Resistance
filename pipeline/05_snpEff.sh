...
#SNPEFFGENOME=Homalodisca_vitripennis_A6A7A9_masurca_v1_ragtag_v1
GFFGENOME=Homalodisca_vitripennis_A6A7A9_masurca_v1_ragtag_v1.gff3 
...
if [ -f config_int.txt ]; then
  source config_int.txt
fi

GFFGENOMEFILE=$GENOMEFOLDER/$GFFGENOME
REFGENOME=$GENOMEFOLDER/Homalodisca_vitripennis_A6A7A9_masurca_v1_ragtag_v1.scaffolds.fa
...
if [ ! -e $SNPEFFOUT/$snpEffConfig ]; then
  ...
  echo "# Homalodisca_vitripennis_A6A7A9_masurca_v1_ragtag_v1" >> $SNPEFFOUT/$snpEffConfig
  ...
  echo "$SNPEFFGENOME.genome : Homalodisca_vitripennis_A6A7A9_masurca_v1_ragtag_v1 " >> $SNPEFFOUT/$snpEffConfig
